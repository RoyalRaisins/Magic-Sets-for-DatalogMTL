...
# not entailed facts
query_list = [
"ExcessiveHeat(station533)@1294",
"HeatAffectedState(color)@1309",
"HeavyWind(station4863)@1900",
"HeavyWindAffectedState(glakes)@416"
]
...
for query in query_list:
    ...
    init_time = end_init_time - start_canonical_build_time
    ...
    try:
        ...
        with open(f"./weather_new_program_results_not_entailed/{str(F)}_magic_new_inside.txt", 'w') as f:
    ...
    print("end with cr!")
    with open(f"./weather_new_program_results_not_entailed/{str(F)}_magic_new_outside.txt", 'w') as f:
