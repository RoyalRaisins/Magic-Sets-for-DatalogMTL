...
rulepath = f"./lubm_programs/p.txt"
...
D1, common, varrho_left, left_period, left_len, varrho_right, right_period, right_len = find_periods_with_query_list(CR,fact_list,inital_time,datasetname="lubm")
...
for F in fact_list:
    ...
    print("end with cr!")
    with open(f"./lubm_baseline_results/"+str(F)+"_outside.txt", 'w') as f:
